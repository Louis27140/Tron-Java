...
public class ControllerFacade implements IController, IOrderPerformer {
		...
		while (this.getModel().getPlayerBlue().isAlive() && this.getModel().getPlayerRed().isAlive()) {
			...
			if (this.getStackOrder() != null) {
				...
				case KeyEvent.VK_RIGHT:
					this.getModel().getPlayerBlue()
							.setOrientation(this.getModel().getPlayerBlue().getOrientation() + 1);
	...
	/**
	 * 
	 * Method to Choose direction of the player blue.
	 * 
	 */
	...
	/**
	 * 
	 * Method to Choose direction of the player red.
	 * 
	 */
